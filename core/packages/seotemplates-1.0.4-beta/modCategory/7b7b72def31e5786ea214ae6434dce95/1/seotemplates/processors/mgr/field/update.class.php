...
class seoTemplatesFieldUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('seotemplates_field_err_ns');
        }
...
return 'seoTemplatesFieldUpdateProcessor';
